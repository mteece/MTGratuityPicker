#
# Be sure to run `pod spec lint MTGratuityPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of MTGratuityPicker
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Matthew Teece" => "mteece@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Matthew Teece', 'other author'
